...
public class SolrDataImportProperties {
	...
	public static final String FULL_SYNC_CORES = "full_syncCores";
	public static final String DELTA_SYNC_CORES = "delta_syncCores";
	...
	public void loadProperties(boolean force) {
		try {
			...
			if (force || properties == null) {
				...
				logger.info("dataimport.properties:" + dataImportPropertiesPath);
